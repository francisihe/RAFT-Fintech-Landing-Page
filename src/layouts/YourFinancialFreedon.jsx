...
const YourFinancialFreedon = () => {
    return (
        <div className="mt-16 mb-24 max-w-screen lg:max-w-screen md:max-w-screen md:px-14 lg:px-14">
            ...
            <div className=''>
                <img src={financialFreedomImage}
                    ...
                    className='m-auto max-w-screen' />
            </div>

            <div className='flex justify-between py-4 lg:mx-0 md:mx-0'>
                    ...
                    <div className='w-1/3'>
                        ...
                        <p className='text-white text-xs'>Seamlessly transfer funds without the extra cost. Send and receive money with zero bank transfer fees.</p>
                    </div>
